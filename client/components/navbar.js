export const navBar = ()=>{
    ...
    const routes = [
        {link:"http://127.0.0.1:5501/index.html", name:"Home"},
        {link:"http://127.0.0.1:5501/pages/ingredientes/index.html", name:"Ingredientes"},
        {link:"http://127.0.0.1:5501/pages/recetas/index.html", name:"Recetas"}
    ]
    return `
